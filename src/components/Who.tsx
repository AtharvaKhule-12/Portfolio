  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div className="my-4">
        <a href="https://drive.google.com/file/d/1jmcBaQTgmu1uStUcWC17jeufudrlHTTI/view?usp=sharing" className="p-2 text-buttonText bg-gray-600 rounded-md hover:bg-gray-400 focus:ring-0 active:bg-gray-400 active:shadow-lg transition duration-150 ease-in-out" target="_blank">Download CV</a></div>
      </div>
    </div>
  );
};
